...
export const ServiceListingPage = () => {
  ...
  useEffect(() => {
    getAllServicesByVendorId.mutate(  
      {
        page: currentPage,
        limit,
        search: searchQuery,
      ...
      >
        ...
        <div className="flex gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuItem onClick={() => toggleSort("serviceTitle")}>
                By Name {sortBy === "serviceTitle" && (sortOrder === "asc" ? "↑" : "↓")}
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => toggleSort("servicePrice")}>
                By Price {sortBy === "servicePrice" && (sortOrder === "asc" ? "↑" : "↓")}
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => toggleSort("serviceCategory")}>
                By Experience {sortBy === "serviceCategory" && (sortOrder === "asc" ? "↑" : "↓")}
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
