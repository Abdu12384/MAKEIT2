          ...
          >
            <div className="p-6">
              ...
              >
                ...
                <p className="text-gray-500">Premium Vendor</p>
              ...
              <motion.div
                ...
                animate="visible"
                variants={sidebarItemVariants}
                className="bg-purple-50/70 backdrop-blur-sm rounded-lg p-4 mb-6"
              >
                <div className="flex items-center space-x-3 mb-2">
                  <Activity className="h-5 w-5 text-purple-600" />
                  <h3 className="font-semibold text-gray-700">Account Status</h3>
                </div>
                <p className="text-sm text-gray-600 mb-2">Your account is active and in good standing.</p>
                ...
                <p className="text-xs text-gray-500 mt-1">92% health score</p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <span className="text-gray-700">Saved Events</span>
                </motion.a>
