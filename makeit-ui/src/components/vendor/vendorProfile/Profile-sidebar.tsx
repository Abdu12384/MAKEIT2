...
import { Settings, User, Briefcase, ImageIcon, Calendar, Clock, Key, Wallet, Menu, ChevronRight } from "lucide-react"
...
const menuItems = [
  ...
  { id: "samples", label: "Work Samples", icon: ImageIcon, path: "/vendor/samples" },
  { id: "bookings", label: "Bookings", icon: Calendar, path: "/vendor/bookings" },
  { id: "events", label: "Events", icon: Clock, badge: "New", path: "/vendor/events" },
  { id: "password", label: "Change Password", icon: Key, path: "/vendor/password" },
