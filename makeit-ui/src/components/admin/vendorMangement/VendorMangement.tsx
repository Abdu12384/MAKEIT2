  ...
  const vendors = [
    {
      ...
      contact: "contact@cateringservices.com",
      rating: 4.9,
      status: "Active",
    },
    {
    ...
    },
    {
      ...
      contact: "hello@eventdecorators.com",
      rating: 4.7,
      status: "Active",
    },
    {
      ...
      contact: "info@securityexperts.com",
      rating: 4.6,
      status: "Active",
    },
    {
    ...
    },
    {
      ...
      contact: "bookings@transportsolutions.com",
      rating: 4.4,
      status: "Active",
    },
  ]
    ...
    >
      ...
      <div className="bg-gray-800 rounded-xl p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-6 text-sm text-gray-400">
          <span>Showing 1-6 of 6 vendors</span>
