...
export const Sidebar: React.FC = () => {
  const menuItems = [
    ...
    { id: "users", path: "/users", label: "User Management", icon: <Users size={20} /> },
    { id: "vendors", path: "/vendors", label: "Vendor Management", icon: <Store size={20} /> },
    { id: "categories", path: "/categories", label: "Category Management", icon: <FolderTree size={20} /> },
    { id: "wallet", path: "/wallet", label: "Wallet", icon: <Wallet size={20} /> },
  ]
